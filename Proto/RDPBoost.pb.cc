...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_ProtoMessage_RDPBoost_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_ProtoMessage_RDPBoost_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_RDPBoost_2eproto[4];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_RDPBoost_2eproto[2];
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_RDPBoost_2eproto_sccs[4] = {
  &scc_info_EndPointInfo_RDPBoost_2eproto.base,
  &scc_info_MouseMessage_RDPBoost_2eproto.base,
