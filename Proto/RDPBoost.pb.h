...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Proto_2fRDPBoost_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Proto_2fRDPBoost_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Proto_2fRDPBoost_2eproto
...
struct TableStruct_Proto_2fRDPBoost_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Proto_2fRDPBoost_2eproto;
class EndPointInfo;
...
enum StatusMessage_StatusType : int {
  StatusMessage_StatusType_CLIENT_ONLINE = 0,
  StatusMessage_StatusType_CLIENT_OFFLINE = 1,
  StatusMessage_StatusType_StatusMessage_StatusType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  StatusMessage_StatusType_StatusMessage_StatusType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool StatusMessage_StatusType_IsValid(int value);
constexpr StatusMessage_StatusType StatusMessage_StatusType_StatusType_MIN = StatusMessage_StatusType_CLIENT_ONLINE;
constexpr StatusMessage_StatusType StatusMessage_StatusType_StatusType_MAX = StatusMessage_StatusType_CLIENT_OFFLINE;
constexpr int StatusMessage_StatusType_StatusType_ARRAYSIZE = StatusMessage_StatusType_StatusType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* StatusMessage_StatusType_descriptor();
template<typename T>
inline const std::string& StatusMessage_StatusType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, StatusMessage_StatusType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function StatusMessage_StatusType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    StatusMessage_StatusType_descriptor(), enum_t_value);
}
inline bool StatusMessage_StatusType_Parse(
    const std::string& name, StatusMessage_StatusType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<StatusMessage_StatusType>(
...
enum ProtoMessage_DataType : int {
  ...
  ProtoMessage_DataType_STATUS_INFO = 3,
...
constexpr ProtoMessage_DataType ProtoMessage_DataType_DataType_MAX = ProtoMessage_DataType_STATUS_INFO;
...
class VideoMessage :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_Proto_2fRDPBoost_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_Proto_2fRDPBoost_2eproto;
};
// -------------------------------------------------------------------
...
class StatusMessage :
 ...
 public:
  ...
  static constexpr StatusType CLIENT_ONLINE =
    StatusMessage_StatusType_CLIENT_ONLINE;
  static constexpr StatusType CLIENT_OFFLINE =
    StatusMessage_StatusType_CLIENT_OFFLINE;
  ...
  static inline const std::string& StatusType_Name(T enum_t_value) {
    ...
    return StatusMessage_StatusType_Name(enum_t_value);
  }
  ...
  void clear_status();
  ::StatusMessage_StatusType status() const;
  void set_status(::StatusMessage_StatusType value);
  private:
  ::StatusMessage_StatusType _internal_status() const;
  void _internal_set_status(::StatusMessage_StatusType value);
  public:
...
class ProtoMessage :
 ...
 public:
  ...
  static constexpr DataType STATUS_INFO =
    ProtoMessage_DataType_STATUS_INFO;
  ...
  bool has_statusmessagei() const;
  private:
  bool _internal_has_statusmessagei() const;
  public:
  void clear_statusmessagei();
  const ::StatusMessage& statusmessagei() const;
  ::StatusMessage* release_statusmessagei();
  ::StatusMessage* mutable_statusmessagei();
  void set_allocated_statusmessagei(::StatusMessage* statusmessagei);
  private:
  const ::StatusMessage& _internal_statusmessagei() const;
  ::StatusMessage* _internal_mutable_statusmessagei();
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VideoMessage::_internal_width() const {
  return width_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 VideoMessage::width() const {
  // @@protoc_insertion_point(field_get:VideoMessage.width)
  return _internal_width();
}
inline void VideoMessage::_internal_set_width(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  width_ = value;
}
inline void VideoMessage::set_width(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VideoMessage::_internal_height() const {
  return height_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 VideoMessage::height() const {
  // @@protoc_insertion_point(field_get:VideoMessage.height)
  return _internal_height();
}
inline void VideoMessage::_internal_set_height(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  height_ = value;
}
inline void VideoMessage::set_height(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::StatusMessage_StatusType StatusMessage::_internal_status() const {
  return static_cast< ::StatusMessage_StatusType >(status_);
}
inline ::StatusMessage_StatusType StatusMessage::status() const {
  // @@protoc_insertion_point(field_get:StatusMessage.Status)
  return _internal_status();
}
inline void StatusMessage::_internal_set_status(::StatusMessage_StatusType value) {
  
  status_ = value;
}
inline void StatusMessage::set_status(::StatusMessage_StatusType value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:StatusMessage.Status)
}
...
// .StatusMessage StatusMessageI = 5;
inline bool ProtoMessage::_internal_has_statusmessagei() const {
  return data_case() == kStatusMessageI;
}
inline bool ProtoMessage::has_statusmessagei() const {
  return _internal_has_statusmessagei();
}
inline void ProtoMessage::set_has_statusmessagei() {
  _oneof_case_[0] = kStatusMessageI;
}
inline void ProtoMessage::clear_statusmessagei() {
  if (_internal_has_statusmessagei()) {
    delete data_.statusmessagei_;
    clear_has_data();
  }
}
inline ::StatusMessage* ProtoMessage::release_statusmessagei() {
  // @@protoc_insertion_point(field_release:ProtoMessage.StatusMessageI)
  if (_internal_has_statusmessagei()) {
    clear_has_data();
      ::StatusMessage* temp = data_.statusmessagei_;
    data_.statusmessagei_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::StatusMessage& ProtoMessage::_internal_statusmessagei() const {
  return _internal_has_statusmessagei()
      ? *data_.statusmessagei_
      : *reinterpret_cast< ::StatusMessage*>(&::_StatusMessage_default_instance_);
}
inline const ::StatusMessage& ProtoMessage::statusmessagei() const {
  // @@protoc_insertion_point(field_get:ProtoMessage.StatusMessageI)
  return _internal_statusmessagei();
}
inline ::StatusMessage* ProtoMessage::_internal_mutable_statusmessagei() {
  if (!_internal_has_statusmessagei()) {
    clear_data();
    set_has_statusmessagei();
    data_.statusmessagei_ = CreateMaybeMessage< ::StatusMessage >(
        GetArenaNoVirtual());
  }
  return data_.statusmessagei_;
}
inline ::StatusMessage* ProtoMessage::mutable_statusmessagei() {
  // @@protoc_insertion_point(field_mutable:ProtoMessage.StatusMessageI)
  return _internal_mutable_statusmessagei();
}
...
template <> struct is_proto_enum< ::StatusMessage_StatusType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::StatusMessage_StatusType>() {
  return ::StatusMessage_StatusType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Proto_2fRDPBoost_2eproto
