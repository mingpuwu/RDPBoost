...
const ::google::protobuf::MessageLite::ClassDataLite<54>
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> TestAllTypes_NestedMessage::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(),  // to_prefetch
...
inline PROTOBUF_NDEBUG_INLINE TestAllTypes::Impl_::Impl_(
    ...
    const Impl_& from, const ::proto3_arena_lite_unittest::TestAllTypes& from_msg)
...
TestAllTypes::TestAllTypes(
  ...
  _impl_.optional_nested_message_ = (cached_has_bits & 0x00000001u) ? ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(
                              arena, *from._impl_.optional_nested_message_)
                        : nullptr;
  _impl_.optional_foreign_message_ = (cached_has_bits & 0x00000002u) ? ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::ForeignMessage>(
  ...
  _impl_.optional_public_import_message_ = (cached_has_bits & 0x00000008u) ? ::google::protobuf::MessageLite::CopyConstruct<::protobuf_unittest_import::PublicImportMessage>(
                        ...
                        : nullptr;
  _impl_.optional_lazy_message_ = (cached_has_bits & 0x00000010u) ? ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(
  ...
  switch (oneof_field_case()) {
    case ONEOF_FIELD_NOT_SET:
      ...
      case kOneofNestedMessage:
        _impl_.oneof_field_.oneof_nested_message_ = ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(arena, *from._impl_.oneof_field_.oneof_nested_message_);
        break;
      case kOneofString:
...
const ::_pbi::TcParseTable<5, 51, 10, 206, 17> TestAllTypes::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::TestAllTypes>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    ...
    if (cached_has_bits & 0x00000001u) {
      ...
      if (_this->_impl_.optional_nested_message_ == nullptr) {
        _this->_impl_.optional_nested_message_ =
            ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(arena, *from._impl_.optional_nested_message_);
      } else {
    ...
    if (cached_has_bits & 0x00000002u) {
      ...
      if (_this->_impl_.optional_foreign_message_ == nullptr) {
        _this->_impl_.optional_foreign_message_ =
            ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::ForeignMessage>(arena, *from._impl_.optional_foreign_message_);
      } else {
    ...
    if (cached_has_bits & 0x00000010u) {
      ...
      if (_this->_impl_.optional_lazy_message_ == nullptr) {
        _this->_impl_.optional_lazy_message_ =
            ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(arena, *from._impl_.optional_lazy_message_);
      } else {
      ...
      case kOneofNestedMessage: {
        if (oneof_needs_init) {
          _this->_impl_.oneof_field_.oneof_nested_message_ =
              ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes_NestedMessage>(arena, *from._impl_.oneof_field_.oneof_nested_message_);
        } else {
...
inline PROTOBUF_NDEBUG_INLINE TestPackedTypes::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::proto3_arena_lite_unittest::TestPackedTypes& from_msg)
...
const ::_pbi::TcParseTable<4, 14, 0, 0, 7> TestPackedTypes::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::TestPackedTypes>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
inline PROTOBUF_NDEBUG_INLINE TestUnpackedTypes::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::proto3_arena_lite_unittest::TestUnpackedTypes& from_msg)
      : repeated_int32_{visibility, arena, from.repeated_int32_},
        repeated_int64_{visibility, arena, from.repeated_int64_},
        repeated_uint32_{visibility, arena, from.repeated_uint32_},
        repeated_uint64_{visibility, arena, from.repeated_uint64_},
...
const ::_pbi::TcParseTable<4, 14, 0, 0, 2> TestUnpackedTypes::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::TestUnpackedTypes>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
  ...
  _internal_metadata_.Clear<std::string>();
        ...
        ::uint8_t* TestUnpackedTypes::_InternalSerialize(
          ...
          for (int i = 0, n = this_._internal_repeated_nested_enum_size(); i < n; ++i) {
            target = stream->EnsureSpace(target);
            target = ::_pbi::WireFormatLite::WriteEnumToArray(
                14, static_cast<::proto3_arena_lite_unittest::TestAllTypes_NestedEnum>(this_._internal_repeated_nested_enum().Get(i)),
                target);
          }
...
inline PROTOBUF_NDEBUG_INLINE NestedTestAllTypes::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::proto3_arena_lite_unittest::NestedTestAllTypes& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0} {}
...
NestedTestAllTypes::NestedTestAllTypes(
  ...
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
  ::uint32_t cached_has_bits = _impl_._has_bits_[0];
  _impl_.child_ = (cached_has_bits & 0x00000001u) ? ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::NestedTestAllTypes>(
                              arena, *from._impl_.child_)
                        : nullptr;
  _impl_.payload_ = (cached_has_bits & 0x00000002u) ? ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes>(
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataLite<46>
...
const ::_pbi::TcParseTable<1, 2, 2, 0, 2> NestedTestAllTypes::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::NestedTestAllTypes>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      ...
      if (_this->_impl_.child_ == nullptr) {
        _this->_impl_.child_ =
            ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::NestedTestAllTypes>(arena, *from._impl_.child_);
      } else {
    ...
    if (cached_has_bits & 0x00000002u) {
      ...
      if (_this->_impl_.payload_ == nullptr) {
        _this->_impl_.payload_ =
            ::google::protobuf::MessageLite::CopyConstruct<::proto3_arena_lite_unittest::TestAllTypes>(arena, *from._impl_.payload_);
      } else {
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> ForeignMessage::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::ForeignMessage>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // int32 c = 1;
    {::_pbi::TcParser::FastV32S1,
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::MessageLite::ClassDataLite<44>
...
const ::_pbi::TcParseTable<0, 0, 0, 0, 2> TestEmptyMessage::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallbackLite,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::proto3_arena_lite_unittest::TestEmptyMessage>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
